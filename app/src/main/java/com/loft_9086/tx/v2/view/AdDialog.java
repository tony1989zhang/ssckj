...
public class AdDialog extends AlertDialog {
    ...
    private final float H_W = 1.4f;//7.0f / 5.0f;
    ...
    public AdDialog(Context context, int theme, List<String> imageList) {
        super(context, theme);
        this.context = context;
    ...
    private class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            params.width = getScreenWidth() - dpToPx(70);
            params.height = (int)(params.width * H_W);
            imageView.setLayoutParams(params);
            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
//            imageView.setImageDrawable(imageList.get(position));
            ConnectionUtil.getInstance().loadImgae(imageView,imageList.get(position));
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onDialogOnClickListener.getAdDialogOnCLickListener(position);
                }
            });
    ...
    OnDialogOnClickListener onDialogOnClickListener;
    ...
    public interface  OnDialogOnClickListener{
         void getAdDialogOnCLickListener(int position);
    }
}